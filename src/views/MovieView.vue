    ...
    <div v-if="queryResults !== null && hasMovieDataRetreived !== false" class="flex flex-col m-[10px]">
        <div :style="{ maxWidth: '1400px' }" class="movieContainer">
            <div class="flex justify-center items-start">
                ...
                <img v-if="queryResults.poster_path" :src="imageBaseURL + queryResults.poster_path"
                    :alt="`Image for ${queryResults.title}`" width="500px" class="bigMoviePhoto" />
            ...
            <div class="flex flex-col">
                ...
                <span>Genres: <span v-for="item, index in queryResults.genres" :key="index">{{ item.name }}<span
                            v-if="index !== queryResults.genres.length - 1">, </span></span></span>
                ...
                <AddToListButton :deleteButton="true" @rating-value="handleRatingValue" :myListData="listDataArr"
        ...
        <div class="flex flex-col">
            ...
            <SimilarGrid :list-data-arr="listDataArr" v-if="queryResults.similar.results.length > 0"
                :similar-obj-array="queryResults.similar.results" />
            <p v-else class="text-[30px] font">Nothing here...</p>
        </div>
    </div>
