...
<template>
    <div
        class="mt-[75px] flex flex-col rounded-[10px] loginShadow justify-between items-center box-shad bg-white w-[80%] max-w-[483px]">
        <Form class="flex flex-col w-full mt-[75px]" v-slot="$form" :initialValues :resolver
        ...
        <div class="roundLoginFooter flex items-center justify-center bg-[#f7f9fc] w-full h-[75px] mt-[100px]">
            <span>Already have an account? <span class="text-[#E53939]">
